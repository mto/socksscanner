 ...
 * @date: 10/11/17
 */
public class GoogleSocks4Checker {

    private final static Logger LOGGER = LoggerFactory.getLogger(GoogleSocks4Checker.class);
    ...
    public GoogleSocks4Checker(int nbThreads) {
    ...
    public void checkSocks4Proxy(SocksProxyAddress spa) {
        ...
        bs.group(group)
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    protected void initChannel(SocketChannel ch) throws Exception {
                        ...
                        pp.addLast(new Socks4ProxyHandler(new InetSocketAddress(spa.host, spa.port)));
    ...
    public static void main(String[] args) {
        GoogleSocks4Checker gsc = new GoogleSocks4Checker(10);
        gsc.checkSocks4Proxy(new SocksProxyAddress("60.205.227.57", 1080));
